...
(function () {
  /* ── Use global credentials from config.js ── */
  var _URL = (typeof SUPABASE_URL !== 'undefined' && SUPABASE_URL) ? SUPABASE_URL : '';
  var _KEY = (typeof SUPABASE_ANON_KEY !== 'undefined' && SUPABASE_ANON_KEY) ? SUPABASE_ANON_KEY : '';
  ...
  function getClient() {
    if (!_sbClient) {
      ...
      if (!_URL) _URL = (typeof SUPABASE_URL !== 'undefined') ? SUPABASE_URL : '';
      if (!_KEY) _KEY = (typeof SUPABASE_ANON_KEY !== 'undefined') ? SUPABASE_ANON_KEY : '';
      if (!_URL || !_KEY) {
